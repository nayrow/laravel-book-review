...
@section('content')
    ...
    <form class="flex flex-line-3 mb-3 " method="GET" action="{{route('books.index')}}">
        <input  class="w-[80%] input h-10" type="text" name="title" placeholder="Search by title..." value="{{request('title')}}"/>
        <input type="hidden" name="filter" value="{{request('filter')}}">
        <button type="submit" class="btn mx-1 h-10">Search</button>
